...
@Data
@Entity
@Table(name = "sniadanie_danie_glowne")
public class BreakfastMainMealData extends ModelData {

	public BreakfastMainMealData() {
		super();
	}

	public BreakfastMainMealData(ModelData modelData) {
		super();
